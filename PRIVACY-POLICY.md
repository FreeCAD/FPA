...
* From **users of the FreeCAD forum and wiki**: The [FreeCAD forum](https://forum.freecad.org) and the [FreeCAD wiki](https://wiki.freecad.org) use [phpBB](https://phpbb.org) and [mediawiki](https://mediawiki.org), respectively. Those applications keep the data that you filled in your user profile in databases, kept securely and managed by the FPA. At minimum, an email address and a password are required to create a user account. Passwords are kept encrypted in the databases. Email addresses are not visible to the public or to other users. Any other personal information you add to these user profiles is publicly visible.

* From **people registering for FPA events**: Registration for the events the FPA organizes (such as FreeCAD Day and the FreeCAD North America Meetup) happens on the FPA's event system at [events.freecad.org](https://events.freecad.org), which runs [Indico](https://getindico.io/). Creating an account there requires at minimum a name, an email address and a password; passwords are kept encrypted. The registration form for an event may ask for additional information needed to organize that particular event, and the form itself shows you what it collects. This data is used only to organize the event: knowing how many people to expect, and contacting you about the event you registered for. It is kept securely and managed by the FPA, is visible only to the organizers of the event, and is never shared with anybody else. As with all other data, you can request, change or delete it at any time by contacting the DPO.

  If you answer an event's call for papers, the proposal you submit (your name, and the title and description of your talk) is likewise visible to the organizers. If your talk is accepted, your name and your talk's title and description are published in the event's program, and remain publicly available indefinitely afterwards: the programs of past events are kept as part of the historical record of the FreeCAD project.
