...
Unfortunately, we have farewell to the bgbsww, which we have been in contact with many times during the year. In order to keep the name alive, we decided to give the name of the 1.0 version that has been developed for years with the community. We commemorate him with gratitude and love from here. And here we report that we are not only financially but also in a familial relationship with the people who are given grants.
