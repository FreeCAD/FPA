...
In 2024 we successfully relaunched the FPA Development Fund grant program. We voted to approve total grant funding in excess of €85.000. While this represents a substantial, and much-needed, increase in funding allocation, it also demonstrated to us that the current structure of rolling grant applications was difficult to budget: we had only allocated €50.000 for the program. While this overrun was not problematic from basic finances standpoint, it points to a systemic flaw in the way grants are allocated.
