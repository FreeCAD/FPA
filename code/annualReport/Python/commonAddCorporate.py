...
def isCorporateDonor(donorName):
    if "GitHub" in donorName:
        # donations from GitHub platform come with description "GitHub Inc" so they get treated as 
        # corporate donations unless we filter them out here
        return False

    corporateTokens = ["co", "ltd", "cie", "ltee", "bv", "b v", "nv", "sa", "llc", "llp", "ltee", "ltda", "pty", "gmbh", "spa", "tech", "technology", "engineering", "partners", "inc", "usa", "design", "germany", "photography", "corporation", "enterprises", "construction", "&", "et", "l l c", "systems", "group", "com", "supply", "business", "electronics", "tool", "systeme", "system"]
...
if len(sys.argv) < 3:
    ...
    print("commonAddCorporate output file: {0}".format(outputFileName))
...
print("commonAddCorporate output out: {0}".format(recordsOut))
